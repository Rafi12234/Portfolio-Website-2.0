  ...
  return (
    <div className="whatIDO">
      <div className="what-box">
        <h2 className="title title-no-split">
        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build full-stack web applications and scalable backend
                features with production-focused workflows.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I design and ship mobile-first user experiences for web and app
                products with a focus on clarity and usability.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
